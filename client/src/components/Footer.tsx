        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              PropEdge Infra, a trusted real estate company in Bhopal with 25+
              years of experience, has served 5,000+ clients and sold 10,00,000+
              sq. ft.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <a
                href="https://www.instagram.com/PropEdge .co.in"
                target="_blank"
              ...
              <a
                href="https://x.com/PropEdge Infra"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-primary transition-colors block"
              >
              ...
              <a
                href="https://youtube.com/@PropEdge realestate"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-primary transition-colors block"
              >
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © 2024 PropEdge Real Estate. All rights reserved.
            </p>
